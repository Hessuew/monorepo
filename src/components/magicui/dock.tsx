...
const dockVariants = cva(
  'supports-backdrop-blur:bg-white/10 supports-backdrop-blur:dark:bg-black/10 mx-auto mt-8 flex h-[80px] w-max items-center justify-center gap-2 rounded-2xl border border-white/40 p-2 backdrop-blur-md'
);
