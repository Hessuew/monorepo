...
export function InputGradient({ text }: { text: string }) {
  return (
    <div className='group relative flex pb-1 items-center justify-center rounded-full px-8 pt-1 shadow-[inset_0_-8px_10px_#8fdfff1f] transition-shadow duration-500 ease-out hover:shadow-[inset_0_-5px_10px_#8fdfff3f] '>
      <span
        className={cn(
