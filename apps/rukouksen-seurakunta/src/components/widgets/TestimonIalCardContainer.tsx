        ...
        >
          ...
          >
            <button
              ...
              className='flex items-center gap-2 px-6 py-2 text-sm font-medium rounded-full transition-all duration-300 focus:outline-hidden focus:ring-2 focus:ring-offset-2 focus:ring-blue-500'
              style={{
