...
export default function FeaturesCard({
  ...
  return (
    <section id='header' className='mt-16 xl:mt-[64px] min-h-[320px]'>
      ...
      <div className='relative bg-black rounded-[24px] w-[310px]'>
        ...
        >
          ...
          <div className='relative z-10'>
            ...
            <p className='mt-1 pr-3 xl:pr-[12px] text-[15px] leading-snug -tracking-[0.03em] xl:mt-[8px] md:mt-2 sm:pr-0 sm:text-[15px]'>
              {description}
            </p>
            <span
              className='mt-[18px] block h-px bg-[rgba(255,255,255,0.10)] xl:mt-[16px] sm:mt-4'
              aria-hidden='true'
            ></span>
            <ul className='mt-6 flex flex-col gap-y-4 xl:gap-y-[12px] xl:mt-[32px] lg:mt-8 md:mt-7 sm:mt-4 sm:gap-y-3'>
              <li className='flex items-center gap-x-2 xl:gap-x-[8px] text-[15px] leading-none tracking-snugger text-white/90 sm:gap-x-1.5 sm:whitespace-nowrap sm:text-[15px] sm:tracking-tight'>
                {features[0]}
              </li>
              <li className='flex items-center gap-x-2 xl:gap-x-[8px] text-[15px] leading-none tracking-snugger text-white/90 sm:gap-x-1.5 sm:whitespace-nowrap sm:text-[15px] sm:tracking-tight'>
                {features[1]}
          ...
          <div className='absolute bottom-[14px] left-[28px] right-[28px] sm:bottom-[20px] sm:left-[14px] sm:right-[14px]'>
            <a
              href={url}
              className='flex justify-center items-center gap-1.5 xl:gap-x-[6px] text-[15px] text-blue-600 hover:text-blue-400 transition-colors group'
              target='_blank'
            ...
            >
              ...
              <ExternalLink className='size-4 xl:size-[16px] transition-transform group-hover:translate-x-0.5 group-hover:-translate-y-0.5' />
            </a>
          </div>
        </div>
      </div>
