...
export function ProjectCard({ title, description, size, url }: ProjectCardProps) {
  return (
    <div
      className={cn(
        'flex w-[470px] h-[320px] relative overflow-hidden rounded-xl border border-gray-700/50 bg-black/30 hover:bg-black/20 transition-all duration-500 hover:border-gray-600'
      )}
    >
